        ...
        return (
          ...
          >
            <div className="text-center">
              <div className="w-32 h-32 mx-auto mb-6 rounded-full border-2 border-dashed border-pink-500 flex items-center justify-center">
        ...
        return (
          ...
          >
            ...
            <p className="text-sm text-white/60 mt-2">
              {data.bio.length}/100 characters
            </p>
          </OnboardingStep>
        )
